...
class context {
   ...
   protected:
    ...
    struct new_eq {
        ...
        new_eq(enode* lhs, enode* rhs, eq_justification const& js) : m_lhs(lhs), m_rhs(rhs), m_justification(js) {}
    };
...
#define INV_ACTIVITY_LIMIT 1e-100
   ...
   public:
    ...
    void mark_as_relevant(expr* n) {
        m_relevancy_propagator->mark_as_relevant(n);
   ...
   public:
    ...
    std::ostream& display_literals_smt2(std::ostream& out, literal l1, literal l2) const {
        literal ls[2] = {l1, l2};
        return display_literals_smt2(out, 2, ls);
    }
